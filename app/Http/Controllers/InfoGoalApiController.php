...
class InfoGoalApiController extends Controller
{
    ...
    public function show($id)
    {
        $gols = DB::table('players')
            ->leftjoin('infogoals', 'players.id', '=', 'infogoals.players_id')
            ->select('players.id AS id', 'players.nome AS jogador', 'infogoals.quantidade AS gols',
                'infogoals.games_id')
    ...
    public function update(Request $request, $id)
    {
        ...
        $infogoals->save();
        return redirect('games')->with(compact('game', 'id'))->with('success', 'Information has been added');
    }
